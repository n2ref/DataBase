 ...
 *  Адаптер PDO_Mssql
 */
class PDO_MssqlAdapter implements IDBAdapter {
    ...
    public function connect ($host, $port, $basename, $user, $pass = '', $charset = 'UTF8', $time_zone = '') {
        ...
        if (in_array(strtolower($charset), array('utf8', 'utf-8'))) {
            $options[] = PDO::SQLSRV_ENCODING_UTF8;
        }

		$link = new PDO("sqlsrv:Server=$host,$port;Database=$basename", $user, $pass, $options);
